...
- Short units introducing new topics
- In-class assignments
- Semester projects
- Emphasis on hands-on, collaborative work

## Topics

- Color representations and image processing
- Dictionaries and text processing
- Object oriented programming
- Sports data analysis
- Data frames and data visualization
- Binary and hexadecimal
- Cellular automata
- Numerical simulation and graphics
- Ciphers and codebreaking
